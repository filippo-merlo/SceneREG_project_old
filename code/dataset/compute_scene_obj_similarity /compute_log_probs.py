    ...
    for candidate in candidates[:100]:
        ...
        for single_candidate in single_candidate_list:
            if single_candidate[0] in ['a', 'e', 'i', 'o', 'u']:
                ...
                article = 'a'
            prompt = f"You are a helpful assistant. Your job is to complete the following sentence with the most appropriate object name. In the {scene_name.replace('_',' ')} there is " + article

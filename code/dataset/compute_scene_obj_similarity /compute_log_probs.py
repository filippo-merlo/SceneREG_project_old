    ...
    for candidate in candidates[:100]:
        ...
        for single_candidate in single_candidate_list:
            if single_candidate[0] in ['a', 'e', 'i', 'o', 'u']:
                ...
                article = 'a'
            prompt = f"You are a helpful assistant. Your job is to complete the following sentence with an object name that is related to the place mentioned in the sentence. In the {scene_name.replace('_',' ')} there is " + article
